...
<div>&nbsp;</div>
<table class="table table-hover tab;e">
	<tr>
		<thead>
	...
	<tr>
		...
		<td class="text-center">
			<a class="btn btn-success" href="detail.php?kode_sup=<?php echo $data['kode_sup']; ?>"><i class="fa fa-info"></i> Detail</a> 
			<a class="btn btn-primary" href="edit.php?kode_sup=<?php echo $data['kode_sup']?>"><i class="fa fa-cut"></i> Edit</a>
