...
INSERT INTO `barang` VALUES (9,'Sabun Dettol','2000','90'),(10,'Buku Novel','2000','90');
...
CREATE TABLE `pembeli` (
  `kode_cus` int(3) NOT NULL AUTO_INCREMENT,
  `nama_cus` varchar(20) DEFAULT NULL,
...
CREATE TABLE `supplier` (
  `kode_sup` int(3) NOT NULL AUTO_INCREMENT,
...
INSERT INTO `supplier` VALUES (8,'Coca-cola Company','@cocacolacompany');
...
-- Dump completed on 2018-09-15 10:53:47
